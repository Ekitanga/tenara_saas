...
WSGI_APPLICATION = 'tenara.wsgi.application'
...
# SMS Configuration (Bonga SMS)
BONGA_API_KEY = config('BONGA_API_KEY', default='')
BONGA_SENDER_ID = config('BONGA_SENDER_ID', default='TENARA')
BONGA_API_URL = config('BONGA_API_URL', default='https://api.bongasms.co.ke/api/send')
